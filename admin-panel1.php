...
if(isset($_POST['docsub']))
{
  ...
  $query="insert into doctb(username,password,email,exper,joindate,spec,docFees)values('$doctor','$dpassword','$demail','$exper','$joindate','$spec','$docFees')";
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <form class="form-group" action="doctorsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="doctor_contact" name="doctor_Name"  placeholder="Search" class = "form-control"></div>
              ...
              <table class="table table-hover">
                <thead>
                  ...
                  <th scope="col">Doctor Name</th>
                    ...
                    <th scope="col">Frequency Time</th>
                ...
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      $route = $row['route'];
                      $frequencytime = $row['frequencytime'];
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-8"><input type="text"  class="form-control" name="exper" required></div><br><br>
                  <div class="col-md-4"><label>Joining Date:</label></div>
                  <div class="col-md-8"><input type="date"  class="form-control" name="joindate" required></div><br><br>
